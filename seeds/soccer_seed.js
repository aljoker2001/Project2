  ...
  return knex('players').del()
    .then(function () {
      ...
      return knex('players').insert([
        ...
        { image: 'https://b.fssta.com/uploads/application/soccer/players/505358.vresize.350.425.medium.64.png', name: 'David Alaba', jersey_number: '33', position: 'Defender' },
        ...
        { image: 'https://marriedbiography.com/wp-content/uploads/2017/12/Emily-Sonnett.jpg', name: 'Emily Sonnett', jersey_number: '24', position: 'Defender' },
        { image: 'https://i8.lisimg.com/8840318/280full.jpg', name: 'Becky Sauerbrunn', jersey_number: '40', position: 'Defender' },
